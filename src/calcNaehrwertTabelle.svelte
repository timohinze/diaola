...
<p>Hundert Gramm des Lebensmittels haben <input type=number max="100" inputmode="decimal" pattern="[0-9]*" class="kohlenhydrate-auf100" bind:value={kohlenhydrateAuf100Gramm} on:input={bolusAusrechnen}  > Gramm Kohlenhydate</p>

<p>Die Portion wiegt <input type=number class="portion-gewicht" inputmode="decimal" pattern="[0-9]*" bind:value={portionGewicht} on:input={bolusAusrechnen}> Gramm</p>
